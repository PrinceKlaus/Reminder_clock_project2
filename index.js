// let display = document.querySelectorAll('.pic1')
// display[0].addEventListener('load' , () =>{
//     function startClock(){
        // let time = new Date();
...
//         display[0].innerHTML = `${hrs} Hours`
//         display[1].innerHTML = `${minutes} Mins`
//         display[2].innerHTML = `${seconds} Seconds`
        
//         if(hours>12){
//             display[3].innerHTML = "PM"
//         }
//         else{
//             display[3].innerHTML = "AM"
//         }
//     }
//     setInterval(() =>{
//         startClock();
